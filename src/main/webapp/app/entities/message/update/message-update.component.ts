...
export class MessageUpdateComponent implements OnInit {
  ...
  protected updateForm(message: IMessage): void {
    ...
    this.ordersSharedCollection = this.orderService.addOrderToCollectionIfMissing<IOrder>(this.ordersSharedCollection, message.user);
  }
  ...
  protected loadRelationshipsOptions(): void {
    this.orderService
      ...
      .pipe(map((orders: IOrder[]) => this.orderService.addOrderToCollectionIfMissing<IOrder>(orders, this.message?.user)))
